# Lista de Tareas para Implementar la Aplicación de Lista de Tareas en Python

## Pasos a Completar

- [x] Crear el archivo tarea_app.py con la estructura básica (lista de tareas, menú principal).
- [x] Implementar la función mostrar_tareas (HU-01: Ver lista de tareas).
- [x] Implementar la función agregar_tarea (HU-02: Agregar tareas, validando no vacías).
